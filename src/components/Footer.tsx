      ...
      <div className="container-px mx-auto max-w-7xl py-14 grid gap-10 md:grid-cols-2 lg:grid-cols-5">
        ...
        <div className="lg:col-span-2">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <div className="font-black text-xl tracking-tight">
                BOX<span className="text-amber-400">CRAFT</span>
              </div>
          ...
          <p className="mt-3 text-sm text-white/70 leading-relaxed max-w-sm">
            Your trusted partner for shipping containers, trailers, and modular cabins. Quality
            products delivered nationwide with exceptional service.
          </p>
        ...
        <div>
          <h4 className="text-sm font-bold uppercase tracking-widest text-amber-400 mb-4">
            Company
          </h4>
          <ul className="space-y-2 text-sm">
            <li>
              <Link to="/about" className="text-white/70 hover:text-amber-400 transition-colors">
                About Us
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link to="/contact" className="text-white/70 hover:text-amber-400 transition-colors">
                Contact
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link to="/faq" className="text-white/70 hover:text-amber-400 transition-colors">
                FAQ
              </Link>
            </li>
            <li>
              <Link to="/privacy" className="text-white/70 hover:text-amber-400 transition-colors">
                Privacy Policy
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link to="/shipping" className="text-white/70 hover:text-amber-400 transition-colors">
                Shipping
              </Link>
            </li>
          </ul>
        ...
        <div>
          ...
          <Link
            to="/contact"
            className="mt-5 w-full text-center inline-flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-400 hover:to-amber-500 text-white font-bold uppercase tracking-wide text-sm rounded-xl transition-all hover:shadow-lg hover:shadow-teal-500/30"
          >
            Get a Free Quote
          </Link>
        </div>
